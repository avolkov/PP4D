...
from optilux.theme.testing import OPTILUX_THEME_INTEGRATION_TESTING, OPTILUX_THEME_FUNCTIONAL_TESTING
...
class TestSetup(unittest.TestCase):
    ...
    def test_theme_configured(self):
        ...
        self.assertEqual(settings.rules, '/++theme++optilux.theme/rules.xml')
        self.assertEqual(settings.absolutePrefix, '/++theme++optilux.theme')
